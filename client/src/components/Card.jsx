...
function Card(props) {
    ...
    if(props.hoverText === "Coming Soon") {
        return (
            <div>
                <div css={{ color: 'black', position: 'relative', transition: 'all .2s ease-in-out', '&:hover': { '& .title': { opacity: '1' }, '& .text-container': { opacity: '0.65' }, '& img': {filter: 'blur(5px)' }}}}>
                    <img src={require(`../assets/images/${props.image}`)}  alt="Coming Soon" css={css`width: 100%; height: 100%; border-radius: 6px;`}></img>
    ...
    return (
        <NavLink to={"/" + props.url}>
            <div css={{ color: 'black', position: 'relative', transition: 'all .2s ease-in-out', '&:hover': { transform: 'scale(1.04)' , '& .title': { opacity: '1' }, '& .text-container': { opacity: '0.6' }}}}>
                <img src={require(`../assets/images/${props.image}`)} alt="Profile" css={css`width: 100%; height: 100%; border-radius: 6px;`}></img>
